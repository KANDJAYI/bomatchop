-- Une commande par vendeur : le panier multi-commerces est découpé côté serveur.
...
grant execute on function public.create_orders_split_by_vendor(public.payment_method, jsonb) to authenticated;
